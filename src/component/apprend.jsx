...
export default function ScrollingTextEffect() {
  ...
  return (
    <div className="relative flex justify-center items-center h-[430px] md:h-[500px] bg-[#F1F0EE] px-6 md:px-[2rem] xl:px-[330px]">
    <div className="grid grid-cols-12  gap-5 w-full lg:items-center justify-start lg:justify-center">
      {/* Left Column */}
      <div className="col-span-12 lg:col-span-6 flex flex-col justify-center">
        <div className="block lg:hidden text-start lg:text-center ">
          <h1 className="text-2xl md:text-6xl -mt-2 font-[600]">
            Apprend
          </h1>
        </div>
        <div className="relative hidden lg:flex flex-col  h-[340px] text-[40px] lg:text-[52px] leading-[62px] lg:font-[600] text-black space-x-2 justify-center">
          <div className=" flex justify-end items-end">
            <span className="relative apprend-span">
              Apprend tes cours
              <img src={Light} alt="icon" className="absolute -top-3 -left-3 w-8 h-8" />
              <img src={Arrow} alt="icon" className="absolute -top-[90px] -right-5 w-[159px]  h-[150px]" />
            </span>
      ...
      {/* Right Column */}
      <div className="relative  col-span-12 lg:col-span-6  flex items-center lg:justify-center justify-start h-[320px]">
        <div className="h-full flex w-full items-center   mask-gradient-main justify-start overflow-hidden">
          <div
            id="scrollableDiv"
            ref={scrollRef}
            ...
            {items.map((item, index) => {
              ...
              return (
                <div key={index} className="framer-1mvu08j flex items-center justify-start" style={{ height: "64px" }}>
                  <h2 className={`framer-text flex items-center gap-3 transition-colors text-left ${isHighlighted ? "text-pink-500" : "text-gray-400"}`}>
                    <span className="text-[20px] font-[600] md:text-5xl leading-[62px] lg:text-[52px]">{item.text}</span>
