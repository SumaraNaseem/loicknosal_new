    ...
    >
      ...
      <div className="relative w-6 h-6 flex items-center justify-center overflow-hidden">
        ...
        <motion.div
          ...
          animate={openIndex === index ? { rotate: 45, scale: 0, opacity: 0 } : { rotate: 0, scale: 1, opacity: 1 }}
          transition={{ duration: 0.2, ease: "easeInOut" }}
          className="absolute"
        >
          <FiPlus className="text-black" size={24} />
        </motion.div>

        {/* Minus Icon Animation */}
        <motion.div
          initial={{ rotate: 0, scale: 0, opacity: 0 }}
          animate={openIndex === index ? { rotate: 0, scale: 1, opacity: 1 } : { rotate: -45, scale: 0, opacity: 0 }}
          transition={{ duration: 0.3, ease: "easeInOut" }}
          className="absolute"
        >
          <FiMinus className="text-black" size={24} />
        </motion.div>
      </div>
    </button>
    <motion.div
