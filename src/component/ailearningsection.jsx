...
const aiLearningSection = () => {
  return (
    <section className="py-12 bg-white text-center  sm:px-6 md:px-[2rem] xl:px-[330px]">
      ...
      {/* First Row */}
      <div className="grid grid-cols-12  w-full px-12 gap-3 lg:gap-10">
        ...
        <div className="flex justify-center items-center">
          ...
          />
          <h2 className={`font-[800]  text-[20px] lg:text-[24px] lg:font-[700] text-[#333333] leading-[36px] text-start mt-4 `}>Arrête de prendre des notes, concentre toi sur ton cours.</h2>
          <p className="text-[17px] lg:text-[20px] lg:font-[500] leading-[28px]  font-[600] mt-2 text-start text-[#888888]">Neuronote enregistre et transcrit l'audio du cours en une fiche parfaitement structuré </p>
            </div>
          </div>
